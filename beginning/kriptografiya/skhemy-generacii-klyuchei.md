...
{% hint style="success" %}
Так же, начиная с _<mark style="color:red;">**v19.4.0**</mark>_ KLYNTAR получил реализацию стандарта BIP-44 и включён в официальный список BIP-44 идентификатором со значением 7331(1337 в обратном направлении). По [_<mark style="color:red;">**ссылке**</mark>_](https://github.com/satoshilabs/slips/pull/1388) можно увидеть мердж в главную ветку регистра
{% endhint %}
