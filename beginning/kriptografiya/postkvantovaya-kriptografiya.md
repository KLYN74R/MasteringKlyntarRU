...
![Группы постквантовых алгоритмов](<../../.gitbook/assets/image (29).png>)
...
{% hint style="danger" %}
Согласно последним данным, NIST кандидат SIKE был [_<mark style="color:red;">**подвергнут атаке**</mark>_](https://eprint.iacr.org/2022/975.pdf). Рекомендуем воздержаться от его использования. Ближе к запуску KLYNTAR Services мы выпустим более содержательные рекомендации по общей безопасности и по использованию постквантовых алгоритмов при взаимодействии между сервисами
{% endhint %}
...
![https://blog.cloudflare.com/nist-post-quantum-surprise/](<../../.gitbook/assets/image (68).png>)
