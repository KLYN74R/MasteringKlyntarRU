...
Приведу пример - пускай у нас есть 10 человек которые решили с помощью BLS мультиподписи сгенерировать подпись(для транзакции, стейкинга, фиксации унобтаниума или чего-то ещё). Пускай 6 из них согласны, а 4 других не хотят
