...
Теперь объединим все подписи в блоке! Представьте, что у нас есть блок с 1000 транзакций, и каждая транзакция содержит подпись _**Si**_ , открытый ключ _**Pi**_ и сообщение, подписанное _**mi**_ . Зачем хранить все подписи, если их можно комбинировать? В конце концов, нас волнует только, действительны ли все подписи в блоке. Агрегированная подпись будет просто суммой всех подписей в блоке:
...
![Укажите адреса разделяя их двоеточием](<../../.gitbook/assets/image (7) (1) (1) (1) (1) (1) (1) (1).png>)
