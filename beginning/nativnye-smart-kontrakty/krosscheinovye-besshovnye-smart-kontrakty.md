...
Давайте предположим что наше приложение - это что-то типа обменника с дополнительной логикой. Пользователи могут вносить токены и монеты на контракт Polygon и при этом отправлять монеты на соответствующие адреса на Litecoin для проведения определённых операций. Так же благодаря операциям на Litecoin можно выполнять смарт-контракты.
