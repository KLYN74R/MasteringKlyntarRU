...
Вы сможете с помощью рассчётных таблиц назаначать цену опкодам за выполнение, предоставлять доступ к импортируемым объектам, предоставлять разные API для контрактов и многое другое.
