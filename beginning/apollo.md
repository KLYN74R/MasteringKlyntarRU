...
Теперь коротко об UI части. Опять таки можем представить что мы работаем с тем же выдуманным модулем который предоставляет нам советы на стейкинг унобтаниума.
